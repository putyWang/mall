...
function setArea() {
    ...
    a.def = {text: n,val: i}, e.find("ul").eq(0).after(s.process(a)), t = $("#home-area"), t.Jdropdown({event: "click"}), t.find(".dd ul a[data-id]").click(function() {
        ...
        createCookie("areaId", e, 10, "/;com.ego.order.domain=jd.com"), createCookie("ipLoc-djd", e + "-0-0-0", 10, "/;com.ego.order.domain=jd.com"), location.href = "http://www.jd.com/", t.removeClass("hover")
    })
}
...
ABTest.prototype = {test: function() {
        ...
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;com.ego.order.domain=jd.com"), console.log(i)
