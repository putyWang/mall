...
function setCookie(name, value, date) {
    ...
    document.cookie = name + "=" + escape(value) + ";expires=" + exp.toGMTString() + ";path=/;com.ego.order.domain=."+locPageHost;
}
