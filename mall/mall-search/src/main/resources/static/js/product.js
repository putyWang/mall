...
function setCookie(t, e, i) {
    var s = i, a = new Date;
    a.setTime(a.getTime() + 1e3 * 60 * 60 * 24 * s), document.cookie = t + "=" + escape(e) + ";expires=" + a.toGMTString() + ";path=/;com.ego.order.domain=.jd.com"
}
function getCookie(t) {
    var e = document.cookie.match(RegExp("(^| )" + t + "=([^;]*)(;|$)"));
    return null != e ? unescape(e[2]) : null
...
//            }})
        ...
        createCookie("__jda", "122270672." + i + ".043878.1386043878.1386043878.1", 10, "/;com.ego.order.domain=jd.com"), 0
